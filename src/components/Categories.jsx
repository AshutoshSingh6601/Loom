              ...
              ? categoriesData.map((vendor, i) => (
                  <div key={i} className="">
                    <img
                      src={vendor.Image}
                      alt=""
                      className="h-[20rem] w-full  border border-[#38444d5c] sm:h-h-[20rem] sm:w-full object-cover object-left-top rounded"
                    />
              ...
              : vendorDetails.map((vendor, i) => (
                  <div key={i} className="w-full">
                    <img
                      src={vendor.Image}
                      alt=""
                      className="h-[20rem] w-full border border-[#38444d5c] sm:h-[20rem] sm:w-full object-cover object-left-top rounded"
                    />
                    <div className="text-left ps-3 mb-5">
                      <p>
                        <span className="font-bold">Name: </span> {vendor.name}
